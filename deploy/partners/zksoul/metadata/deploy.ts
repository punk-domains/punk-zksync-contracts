...
// npx hardhat deploy-zksync --script deploy/partners/zksoul/metadata/deploy.ts --network zkSyncTestnet
...
const contractName = "ZksoulMetadata";
const argsFullPath = "deploy/partners/zksoul/metadata/args.ts";
