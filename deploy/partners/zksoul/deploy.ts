...
// npx hardhat deploy-zksync --script deploy/partners/zksoul/deploy.ts --network zkSyncTestnet
...
const contractName = "ZksoulMinter";
const argsFullPath = "deploy/partners/zksoul/args.ts";
