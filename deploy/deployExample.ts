...
// npx hardhat deploy-zksync --script deploy/deployExample.ts --network zkSyncTestnet
...
const argsFullPath = "deploy/argsExample.ts";
const constructorArgs = require("./argsExample.ts");
